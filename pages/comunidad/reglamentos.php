...
<main class="max-w-7xl mx-auto px-4 py-10">
  ...
  <section class="mt-10">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      <a href="<?php echo $assetBase; ?>/PDFs/Reglamento-Escolar-UNEG-2025.pdf" target="_blank" rel="noopener" class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm hover:shadow-md transition">
      ...
      <a href="<?php echo $assetBase; ?>/PDFs/reglamento-de-biblioteca-adrian-mora-duhart.pdf" target="_blank" rel="noopener" class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm hover:shadow-md transition">
        <div class="mx-auto h-14 w-14 rounded-full bg-[#0b2c65] text-white flex items-center justify-center">
      ...
      <a href="<?php echo $assetBase; ?>/PDFs/reglamento-general-para-estudios-de-licenciatura-y-posgrado.pdf" target="_blank" rel="noopener" class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm hover:shadow-md transition">
        <div class="mx-auto h-14 w-14 rounded-full bg-[#0b2c65] text-white flex items-center justify-center">
