...
<main class="max-w-7xl mx-auto px-4 py-10">
  <section class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
    <img src="<?php echo $assetBase; ?>/imgs/nms/cch/hero.png" alt="Doctorado en Educación, Sistema de Aprendizaje en Línea" class="block w-full h-auto" loading="eager">
  ...
  <section class="mt-10 text-center">
    <h1 class="text-2xl sm:text-3xl font-semibold text-[#0b2c65]">Doctorado en Educación, Sistema de Aprendizaje en Línea</h1>
    <p class="mt-2 text-slate-600">Contenido en construcción para este doctorado.</p>
  </section>
