...
<section class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
  <img src="<?php echo $assetBase; ?>/imgs/nms/cch/hero.png" alt="Maestría en Tecnologías de Información y Comunicaciones" class="block w-full h-auto" loading="eager">
  ...
  <section class="mt-10 text-center">
    <h1 class="text-2xl sm:text-3xl font-semibold text-[#0b2c65]">Maestría en Tecnologías de Información y Comunicaciones</h1>
    <p class="mt-2 text-slate-600">Contenido en construcción para esta maestría.</p>
  </section>
