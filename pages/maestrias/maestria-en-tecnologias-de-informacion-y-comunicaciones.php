...
<section class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
  <img src="<?php echo $assetBase; ?>/imgs/maestrias/tecnologias-de-informacion-y-comunicaciones/hero.png" alt="Maestría en Tecnologías de Información y Comunicaciones" class="block w-full h-auto" loading="eager">
