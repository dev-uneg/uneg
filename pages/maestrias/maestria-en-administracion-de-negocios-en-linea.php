...
<section class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
  <img src="<?php echo $assetBase; ?>/imgs/maestrias/administracion-de-negocios-en-linea/hero.png" alt="Maestría en Administración de Negocios en Línea" class="block w-full h-auto" loading="eager">
