...
<section class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
    <img src="<?php echo $assetBase; ?>/imgs/maestrias/administracion-de-negocios/hero.png" alt="Maestría en Administración de Negocios" class="block w-full h-auto" loading="eager">
