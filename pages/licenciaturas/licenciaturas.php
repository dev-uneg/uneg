...
<main class="max-w-7xl mx-auto px-4 py-10">
  <section class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
    <img src="<?php echo $assetBase; ?>/imgs/nms/cch/hero.png" alt="Licenciaturas" class="block w-full h-auto" loading="eager">
  ...
  <section class="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
    <article class="rounded-xl border border-slate-200 bg-white p-6 text-center shadow-sm">
      <div class="mx-auto h-24 w-24 rounded-full bg-slate-100 flex items-center justify-center text-slate-500">IMG</div>
