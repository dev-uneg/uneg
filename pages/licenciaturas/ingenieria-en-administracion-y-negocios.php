...
<section class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
    <img src="<?php echo $assetBase; ?>/imgs/licenciaturas/ingenieria-en-administracion-y-negocios/hero-ingenieria-administracion-negocios.png" alt="Contaduría Pública Estratégica" class="block w-full h-auto" loading="eager">
