...
if ($autoload === null) {
    ...
    echo 'Falta autoload de Composer. Sube app/vendor o ejecuta composer install en app/ o en raiz.';
    exit;
}
...
$router->map('GET', '/comunidad/eventos-docentes', function (): void {
    require __DIR__ . '/pages/comunidad/eventos-docentes.php';
});
...
$router->map('GET', '/admin/buzon-rector/show', function (): void {
    require __DIR__ . '/controllers/admin/buzon_show.php';
});
