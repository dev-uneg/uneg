...
<section class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
    <img src="<?php echo $assetBase; ?>/imgs/licenciaturas/derecho/hero-derecho.png" alt="Contaduría Pública Estratégica" class="block w-full h-auto" loading="eager">
