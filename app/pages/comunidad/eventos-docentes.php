...
<main class="max-w-7xl mx-auto px-4 py-10">
  <section class="relative overflow-hidden rounded-2xl bg-gradient-to-r from-[#1f56ad] via-[#2f6bd0] to-[#5a8fe0] text-white">
    ...
    <div class="relative px-6 py-12 text-center">
      ...
      <h1 class="mt-4 text-3xl sm:text-5xl font-semibold">Eventos Docentes</h1>
      <p class="mt-4 text-base sm:text-lg">Consulta próximas actividades y eventos para profesores ISEC.</p>
    </div>
  </section>
