...
<main class="max-w-7xl mx-auto px-4 py-10">
  ...
  <section class="mt-10 text-center">
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-0 rounded-2xl border border-slate-200 bg-white overflow-hidden text-left">
      ...
      <a href="<?php echo $assetBase; ?>/assets/docs/convenios-servicio-social-directores.pdf" target="_blank" rel="noopener" class="p-6 text-center transition hover:bg-slate-50 border-b border-slate-200 sm:border-l lg:border-b">
