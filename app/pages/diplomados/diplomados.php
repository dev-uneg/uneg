...
<main class="max-w-7xl mx-auto px-4 py-10">
  <section class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
    <img src="<?php echo $assetBase; ?>/imgs/diplomados/hero.jpg" alt="Diplomados" class="block w-full h-auto" loading="eager">
  ...
  <section class="mt-8">
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
      <button type="button" class="group rounded-2xl border border-slate-200 bg-white p-4 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md" data-lightbox-src="<?php echo $assetBase; ?>/imgs/ixu/diplomados/Diplomado-en-Normas-de-Informacion-Financiera-2.png">
        <img src="<?php echo $assetBase; ?>/imgs/ixu/diplomados/Diplomado-en-Normas-de-Informacion-Financiera-2.png" alt="Diplomado en Normas de Información Financiera" class="w-full h-56 object-contain">
