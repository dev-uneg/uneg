...
<main class="max-w-7xl mx-auto px-4 py-10">
  <section class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
    <img src="<?php echo $assetBase; ?>/imgs/nms/bachillerato-en-linea/hero.png" alt="Bachillerato en línea - Modalidad en línea" class="block w-full h-auto" loading="eager">
