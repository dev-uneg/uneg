...
<section class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
    <img src="<?php echo $assetBase; ?>/_imgs/licenciaturas/contaduria-publica-estrategica/hero-contaduria-publica-estrategica.webp" alt="Contaduría Pública Estratégica" class="block w-full h-auto" loading="eager">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 px-5 py-4 text-sm">
      ...
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-white/70 text-xs">RVOE SEP: 20180766</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <section class="mt-10 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <?php endif; ?>
      <form class="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm" method="post" action="<?php echo $base; ?>/api/forms/licenciaturas-contaduria-publica-estrategica" autocomplete="on">
        ...
        <input type="hidden" name="interest" value="Licenciatura en Contaduría Pública Estratégica" />
  ...
  <section class="mt-12">
    <h2 class="text-center text-2xl sm:text-3xl font-semibold text-[#0b2c65]">Plan de Estudios Licenciatura en Contaduría Pública Estratégica</h2>
