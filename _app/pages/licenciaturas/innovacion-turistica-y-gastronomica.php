...
<section class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
    <img src="<?php echo $assetBase; ?>/_imgs/licenciaturas/innovacion-turistica-y-gastronomica/hero-innovacion-turistica-gastronomica.webp" alt="Innovación Turística y Gastronómica" class="block w-full h-auto" loading="eager">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 px-5 py-4 text-sm">
      ...
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-white/70 text-xs">RVOE SEP: 20180767</p>
        </div>
      </div>
    </div>
  </div>
