...
<section class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
    <img src="<?php echo $assetBase; ?>/_imgs/licenciaturas/pedagogia/hero-pedagogia.webp" alt="Pedagogía" class="block w-full h-auto" loading="eager">
  ...
  <section class="mt-10 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <?php endif; ?>
      <form class="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm" method="post" action="<?php echo $base; ?>/api/forms/licenciaturas-pedagogia" autocomplete="on">
