...
<section class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
  <img src="<?php echo $assetBase; ?>/_imgs/maestrias/derecho-corporativo/hero.webp" alt="Maestría en Derecho Corporativo" class="block w-full h-auto" loading="eager">
