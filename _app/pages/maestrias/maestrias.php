...
<main class="max-w-7xl mx-auto px-4 py-10">
  <section class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
    <img src="<?php echo $assetBase; ?>/_imgs/maestrias/hero.webp" alt="Maestrías" class="block w-full h-auto" loading="eager">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 px-5 py-4 text-sm">
        ...
        <div class="flex items-center gap-3">
          ...
          <div>
            ...
            <p class="text-white/70 text-xs">RVOE SEP (SEGÚN MAESTRÍA)</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="mt-10 text-center">
    <h1 class="text-2xl sm:text-3xl font-semibold text-[#0b2c65]">Maestrías</h1>
    <p class="mt-2 text-slate-600">Contenido en construcción para Maestrías.</p>
  </section>
