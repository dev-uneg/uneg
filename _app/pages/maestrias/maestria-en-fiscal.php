...
<section class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
  <img src="<?php echo $assetBase; ?>/_imgs/maestrias/fiscal/hero.webp" alt="Maestría en Fiscal" class="block w-full h-auto" loading="eager">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 px-5 py-4 text-sm">
      ...
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-white/70 text-xs">RVOE SEP: 20210392</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <section class="mt-10 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <?php endif; ?>
      <form class="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm" method="post" action="<?php echo $base; ?>/api/forms/maestrias-maestria-en-fiscal" autocomplete="on">
    ...
    <div class="max-w-3xl mx-auto">
      ...
      <div class="mt-6 space-y-3">
        ...
        <details class="rounded-lg border border-slate-200 bg-white px-4 py-3">
          ...
          <p class="mt-2 text-slate-600 text-sm">
            La Maestría en Fiscal tiene una duración de cuatro cuatrimestres. En cada uno de ellos se imparten cuatro materias, las cuales se imparten todos los sábados en un horario matutino que abarca de 7:00 am a 01:00 pm de la zona centro de México. Conoce más acerca de ISEC y comienza un nuevo futuro.
          </p>
        </details>
