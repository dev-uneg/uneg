...
<main class="max-w-7xl mx-auto px-4 py-10">
  <section class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
    <img src="<?php echo $assetBase; ?>/_imgs/nms/bachillerato-tecnico-administracion-empresas-turisticas/hero.webp" alt="Bachillerato Técnico en Administración de Empresas Turísticas" class="block w-full h-auto" loading="eager">
  ...
  <section class="mt-10 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <?php endif; ?>
      <form class="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm" method="post" action="<?php echo $base; ?>/api/forms/bachillerato-tecnico-administracion-empresas-turisticas" autocomplete="on">
        ...
        <input type="hidden" name="interest" value="Bachillerato Técnico en Administración de Empresas Turísticas" />
    ...
    <div class="overflow-hidden rounded-2xl shadow-sm">
      ...
      <div class="bg-[#f1f5f9] px-6 py-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div class="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
            <div class="h-10 w-10 rounded-full bg-slate-100 flex items-center justify-center text-[#0b2c65]">
              <i class="text-xl" data-lucide="user"></i>
            </div>
