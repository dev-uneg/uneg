...
<main class="max-w-7xl mx-auto px-4 py-10">
  ...
  <section class="mt-8">
    <div class="news-accordion">
      ...
      $accordionImages = [
        'comunicados-de-rectoria' => $assetBase . '/_imgs/acerca/slide-1.webp',
        'eventos-de-nuestra-comunidad' => $assetBase . '/_imgs/acerca/slide-2.webp',
        'vida-en-el-campus' => $assetBase . '/_imgs/acerca/slide-3.webp',
        'video-blog-uneg-isec' => $assetBase . '/_imgs/home/hero.webp',
      ];
      foreach ($categorias as $cat):
        $img = $accordionImages[$cat['slug']] ?? ($assetBase . '/_imgs/acerca/slide-4.webp');
