...
<main class="max-w-7xl mx-auto px-4 py-10">
  ...
  <section class="mt-10 grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_320px] gap-8 overflow-visible">
    <article class="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
      <div class="w-full">
        <img src="<?php echo $assetBase; ?>/_imgs/noticias/eventos/news-001.webp" alt="Firma de convenio UNEG" class="w-full h-auto block">
      </div>
      ...
      <div class="border-t border-slate-200 bg-white p-6">
        <img src="<?php echo $assetBase; ?>/_imgs/noticias/eventos/news-001-b.webp" alt="Convenio UNEG CAMIC" class="w-full h-auto block rounded-xl">
      </div>
    </article>
