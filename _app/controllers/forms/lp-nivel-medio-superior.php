...
$fail = static function (string $message, int $status = 400) use ($base, $isHtmlRequest, $respondJson): void {
    if ($isHtmlRequest) {
        header('Location: ' . $base . '/lp-nivel-medio-superior?error=1', true, 302);
        exit;
    }
...
$personPayload = [
    ...
    '1cd81947451e14a3c30084a31db4d6eef6fef63e' => 'Sitio web',
];
...
if ($isHtmlRequest) {
    header('Location: ' . $base . '/gracias-lp-nivel-medio-superior', true, 302);
    exit;
}
