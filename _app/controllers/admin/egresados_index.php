...
if (!admin_is_async_request()) {
    $pageTitle = 'Egresados | Admin UNEG';
...
$countStmt = $pdo->prepare('SELECT COUNT(*) FROM egresados' . $whereSql);
...
$stmt = $pdo->prepare('SELECT * FROM egresados' . $whereSql . ' ORDER BY created_at DESC LIMIT :limit OFFSET :offset');
...
ob_start();
require __DIR__ . '/../../pages/admin/egresados.php';
